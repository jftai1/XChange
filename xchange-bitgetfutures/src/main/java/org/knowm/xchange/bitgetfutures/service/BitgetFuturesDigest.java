...
public final class BitgetFuturesDigest extends BaseParamsDigest {

  private BitgetFuturesDigest(String secretKeyBase64) {
    super(secretKeyBase64, HMAC_SHA_256);
  }

  public static BitgetFuturesDigest createInstance(String secretKeyBase64) {
    return secretKeyBase64 == null ? null : new BitgetFuturesDigest(secretKeyBase64);
  }
